...
function navigateWorkspace(){
  ...
  const view=["library","gallery","review","process","results","layouts","editor","delivery","publishing","highlights"].includes(requested)?requested:"library";
...
document.addEventListener("click",event=>{
  ...
  if(!["library","gallery","review","process","results","layouts","editor","delivery","publishing","highlights"].includes(view))return;
