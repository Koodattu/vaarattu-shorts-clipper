...
function navigateWorkspace(){
  ...
  const view=["library","gallery","review","process","results","layouts","editor","delivery","publishing"].includes(requested)?requested:"library";
...
document.addEventListener("click",event=>{
  ...
  if(!["library","gallery","review","process","results","layouts","editor","delivery","publishing"].includes(view))return;
