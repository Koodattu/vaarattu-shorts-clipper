# Transcript presentation and selection, conversation-v3
...
Coarse proposals of 5–90 seconds can reach verification, allowing correction of passage boundaries. Prefer 15–45 seconds and the shortest complete setup/payoff. Never pad to a minimum; a shorter complete joke can qualify. Final automatic selections must be 5–60 seconds, score at least 15/20, score at least 3 for standalone and fidelity, and have no flags. Five seconds is a technical sanity floor, not a prompting target. Refined spans must retain the original idea. Export all non-overlapping passing clips, with no requested minimum or maximum count. Manual edits and saved older clips retain support up to 90 seconds. This is contiguous clipping, without sentence rearrangement or pause removal.
